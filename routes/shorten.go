...
import (
	...
	"github.com/gourav12345-modi/shortify/database"
	"github.com/gourav12345-modi/shortify/helpers"
)
...
func ShortenURL(c *fiber.Ctx) error {
		...
		if !helpers.RemoveDomainError(body.URL) {
			return c.Status(fiber.StatusServiceUnavailable).JSON(fiber.Map{"error": "Can't short given URL"})
		}
